...
class AppComponent extends React.Component{
	...
	componentDidMount(){
		//获取当前窗口的可视宽度
		var windowH = document.body.scrollHeight || document.documentElement.scrollHeight;
		console.log(windowH);

		// 拿到舞台的大小
		var stageDOM = ReactDOM.findDOMNode(this.refs.stage);
			stageDOM.style.height = windowH + 'px';
	...
	render(){
		...
		Array.from(imageDatas).forEach(function(value, index){
			...
			controllerUnits.push(<CotrollerUnit key={index} arrange={this.state.imgsArrangeArr[index]} inverse={this.inverse(index)} center={this.center(index)}/>);
		}.bind(this));
		return (
